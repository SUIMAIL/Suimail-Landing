...
export default function Abitrium(){
    const [openModal, setOpenModal] = useState(false);
    const [isFirstModalOpen, setIsFirstModalOpen] = useState(false);
//const [isSecondModalOpen, setIsSecondModalOpen] = useState(false);

    const [fromCurrency, setFromCurrency] = useState("ARB");
...
<div className="w-[94%] bg-white pb-10 pt-5 mt-3 mx-auto shadow-xl rounded-lg flex flex-col justify-center items-center gap-8">
    <div  className='flex flex-col items-center gap-2'>
        <h3 className='font-semibold text-2xl flex items-center gap-3'>Available ARB balance <Tooltip content="Your avaliable balance is money avaliable for you and you can transfer it out. You can send this money to any crypto assets we support " className='w-[60%] md:w-[30%]' placement="left">
