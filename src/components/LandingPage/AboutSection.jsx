...
export default function HomeAbout() {
    return(
        ...
        <div className="md:py-12 pt-12 pb-8 mx-auto text-center">
            <h1 data-aos="zoom-in" className="font-semibold text-3xl md:leading-[32px] flex items-center justify-center md:gap-5 flex-col md:text-5xl"> Payment without borders, <span className="font-bold text-yellow-500 flex items-center justify-center">  wherever you go.</span></h1>
...
<h5 className="text-sm text-yellow-500 font-semibold uppercase">global bank account</h5>
